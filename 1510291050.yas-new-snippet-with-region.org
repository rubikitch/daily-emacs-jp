...
#+MYTAGS: Emacs, yasnippet リージョンからスニペットを作成, yasnippet from region, relate:yasnippet, yas-new-snippet, yasnippet 新規作成, emacs テンプレート, テンプレート, スニペット, snippet, template, skeleton, package:yasnippet
#+TITLE: Emacs: yasnippetの新規作成時にregionの内容をデフォルトの内容にする
#+begin: org2blog-tags
#+TAGS: Emacs, yasnippet リージョンからスニペットを作成, yasnippet from region, relate:yasnippet, yas-new-snippet, yasnippet 新規作成, emacs テンプレート, テンプレート, スニペット, snippet, template, skeleton, package:yasnippet, Emacs, yasnippet.el, M-x yas-new-snippet, new snippet
#+end:
