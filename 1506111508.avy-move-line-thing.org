...
#+POSTID: 1737
#+DESCRIPTION: 
#+MYTAGS: relate:avy, relate:org, relate:thingatpt, package:avy, package:org
#+TITLE: 【文章作成支援】行移動・org-modeのM-↑/M-↓を開始・終了行指定できるようにしてみた
#+begin: org2blog-tags
#+TAGS: relate:avy, relate:org, relate:thingatpt, package:avy, package:org, Emacs, Emacs Lisp, org-mode, , avy--line, M-x avy-move-line-thing
#+end:
[[http://rubikitch.com/2015/06/10/org-element-at-point][昨日、org-elementをthing-at-pointで扱えるようにしてみた]] けど、
...
行指定ということならば、ace-jump-modeの汎用版ともいえる[[http://rubikitch.com/2015/05/20/avy/][avy.el(レビュー)]] を
使うことにしました。
