...
#+TAGS: package:verify-url, emacs 使い方, emacs コマンド, emacs, verify-url, verify-url.el, emacs lisp verify-url, elisp verify-url, emacs melpa verify-url, emacs verify-url 使い方, emacs verify-url 設定, emacs パッケージ verify-url,  リンク切れ検出, url 存在確認, Emacs, ソース解読推奨, M-x verify-url
...
<tr><td>バージョン</td><td>20160426.528</td></tr>
