...
#+MYTAGS: Rubyによるクローラー開発技法,, Ruby, 著書, Ruby, 佐々木拓郎, SBクリエイティブ, クローラー, Ruby メタプログラミング, Ruby クラス 継承, Ruby サブクラス, Ruby スクレイピング, ruby crawler
#+TAGS: Rubyによるクローラー開発技法,, Ruby, 著書, Ruby, 佐々木拓郎, SBクリエイティブ, クローラー, Ruby メタプログラミング, Ruby クラス 継承, Ruby サブクラス, Ruby スクレイピング, ruby crawler, Ruby, 著書,, Anemone, curl, Parallel, Class#inherited, フック
#+TITLE: 『Rubyによるクローラー開発技法』増刷決定！Amazon 1位なう！！個人用即席クローラーの作り方
[[http://rubikitch.com/2014/08/03/ruby-crawler-book/][新刊『Rubyによるクローラー開発技法』]] が8/25に発売されましたが、
