...
#+DESCRIPTION: 
#+MYTAGS: relate:multicolumn
#+TAGS: relate:multicolumn, Emacs, Emacs 24.4, , M-x follow-mode
#+TITLE: follow-modeで画面最下行が表示されないバグを修正
ワイドディスプレイでEmacsするには *M-x follow-mode* と
[[http://rubikitch.com/2014/12/10/multicolumn/][multicolumn.el(レビュー記事)]] が便利です。
