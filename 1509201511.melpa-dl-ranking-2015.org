...
#+begin: org2blog-tags
#+TAGS: emacs, emacs melpa, emacs パッケージ, emacs 人気 パッケージ, emacs 定番 パッケージ, emacs 人気 elisp, emacs 定番 elisp, emacs おすすめ パッケージ, emacs おすすめ elisp, ruby json open-uri, emacs describe-package,, Emacs, Ruby, 
#+end:
[[http://rubikitch.com/2014/09/02/melpa-dl-ranking/][去年、MELPAのダウンロードランキングを見てみました]] が、
...
更新速度が早いので人気が出ています。
7/11に[[http://rubikitch.com/2015/07/12/helm-core/][helm-core]]パッケージ が出たばかりですが、
わずか2ヶ月で3万を超えるダウンロードを記録しているので伸びが凄まじいです。
magitやdashをも追い抜いてしまうかもしれません!？

4位のpopupは5位の[[http://rubikitch.com/2014/11/05/auto-complete/][auto-complete]] のライブラリです。
