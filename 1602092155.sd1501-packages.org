...
#+DESCRIPTION:
#+TAGS:package:ido package:bs package:ffap package:recentf-ext package:point-undo package:goto-chg package:bm package:imenu package:visual-regexp package:rectangle-mark-mode package:browse-kill-ring#+TITLE: #9 すぐに使える！　便利な 11 のパッケージ (Software Design 2015年1月号掲載記事) Emacs ido bs ffap recentf-ext point-undo goto-chg bm imenu visual-regexp rectangle-mark-mode browse-kill-ring 
