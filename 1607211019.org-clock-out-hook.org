...
#+BLOG: rubikitch
#+CATEGORY: Emacs, org-mode, Emacs 24.4, Emacs 24.5, 
#+DESCRIPTION: 
#+MYTAGS: package:org, org-clock-in-hook, org-clock-out-hook, org-clock-in, org-agenda-clock-in, org-clock-out, org-agenda-clock-out, 音楽の一時停止, bgm一時停止, スケジューリング, スケジュール管理, 時間管理, 仕事術, org-clock-marker, org-get-tags-at, advice-add, relate:nadvice, フック, アドバイス
#+TITLE: Emacs org-mode: org-clock-out-hookの罠！
#+begin: org2blog-tags
#+TAGS: package:org, org-clock-in-hook, org-clock-out-hook, org-clock-in, org-agenda-clock-in, org-clock-out, org-agenda-clock-out, 音楽の一時停止, bgm一時停止, スケジューリング, スケジュール管理, 時間管理, 仕事術, org-clock-marker, org-get-tags-at, advice-add, relate:nadvice, フック, アドバイス, Emacs, org-mode, Emacs 24.4, Emacs 24.5, , 
#+end:
...
そういう場合は[[http://rubikitch.com/2014/10/30/nadvice/][adviceを使う]] ことになります。
