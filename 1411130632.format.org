...
#+CATEGORY: Emacs,
#+DESCRIPTION:
#+MYTAGS: Emacs, Emacs Lisp, number-to-string, char-to-string, buffer-name, symbol-name, prin1-to-string
#+TAGS: Emacs, Emacs Lisp, number-to-string, char-to-string, buffer-name, symbol-name, prin1-to-string, Emacs,, format, printf, string-match, buffer-name, scratch, scratch, scratch, scratch, scratch, scratch, scratch, scratch, concat, scratch, scratch, scratch
