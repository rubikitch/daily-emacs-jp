...
#+CATEGORY: Emacs, 
#+DESCRIPTION: 
#+MYTAGS: Emacs News, Sacha Chua, sachac, reddit.com/r/emacs, Hacker News, planet.emacsen.org, Youtube, the Emacs commit log, Emacs NEWS file,  emacs-devel. emacs-tangents, beginner tips, org-mode, relate:org, coding, configuration, dev news, Sandra Jean Chua
#+TITLE: 最新のEmacs情報を追い掛けたいならばこのブログだけは見ておけ！
#+begin: org2blog-tags
#+TAGS: Emacs News, Sacha Chua, sachac, reddit.com/r/emacs, Hacker News, planet.emacsen.org, Youtube, the Emacs commit log, Emacs NEWS file,  emacs-devel. emacs-tangents, beginner tips, org-mode, relate:org, coding, configuration, dev news, Sandra Jean Chua, Emacs, , 
#+end:
