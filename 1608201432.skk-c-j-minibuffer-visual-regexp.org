...
#+CATEGORY: Emacs, SKK, 
#+DESCRIPTION: 
#+MYTAGS: skk, package:skk, ミニバッファでskkが使えない, relate:visual-regexp, 
#+TITLE: ミニバッファでSKKが使えなくなったらこれをやれ！
#+begin: org2blog-tags
#+TAGS: skk, package:skk, ミニバッファでskkが使えない, relate:visual-regexp, , Emacs, SKK, , 
#+end:
SKKを使っている人へ。
...
最近覚えているものといえば[[http://rubikitch.com/2014/08/26/visual-regexp/][visual-regexp(レビュー)]] を使おうとしたときです。
