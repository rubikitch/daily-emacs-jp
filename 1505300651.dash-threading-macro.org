...
#+DESCRIPTION: 
#+MYTAGS: package:dash, threading macro, elisp メソッドチェーン, 月刊少女野崎くん
#+TITLE: 【dashでメソッドチェーン】月刊少女野崎くんに学ぶthreading macro
#+begin: org2blog-tags
#+TAGS: package:dash, threading macro, elisp メソッドチェーン, 月刊少女野崎くん, Emacs, Emacs Lisp, , メソッドチェーン, dash.el, it
#+end:
** ハンタイのハンタイの〜
...
[[http://furandon-pig.hatenablog.com/entry/2014/07/28/012735][これをEmacs Lispで解いた]] という記事があり、[[http://rubikitch.com/2015/05/28/nozakikun/][先日僕はRubyで解きました]]。
** 語順がああああ
通常のelispでは
