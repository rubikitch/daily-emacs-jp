...
#+begin: org2blog-tags
#+TAGS: save-buffers-kill-emacs, Emacsを終了する, confirm-kill-emacs, 容易にEmacsを終了させない, emacs 終了方法, global-unset-key, global-set-key, define-key, defalias, Emacs, 記事紹介, , save-buffers-kill-emacs
#+end:
