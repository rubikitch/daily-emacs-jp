...
#+CATEGORY: Emacs, 
#+DESCRIPTION: 
#+MYTAGS: save-buffers-kill-emacs, Emacsを終了する, confirm-kill-emacs, 容易にEmacsを終了させない, emacs 終了方法, global-unset-key, global-set-key, define-key, defalias
#+TITLE: うっかりEmacsを終了することを二度となくす超簡単な方法
#+begin: org2blog-tags
#+TAGS: save-buffers-kill-emacs, Emacsを終了する, confirm-kill-emacs, 容易にEmacsを終了させない, emacs 終了方法, global-unset-key, global-set-key, define-key, defalias, Emacs, , save-buffers-kill-emacs
#+end:
...
;;; なんでもいいよ
;; (global-set-key (kbd "C-x C-x") 'some-command)
#+END_SRC
