...
#+MYTAGS: relate:helm-package, relate:helm, relate:color-theme, emacs 色設定, emacs theme, emacs color theme, emacs color-theme.el, emacs スキン, emacs テーマ, emacs skin, emacs color setting, emacs カラーテーマ, emacs テーマ 変更, emacs カラーテーマ 設定, emacs 見た目の変更, emacs 好みの色設定, emacs 背景色, 
#+TITLE: Emacsのcolor-theme(カラーテーマ)を一覧・テスト・設定する
#+begin: org2blog-tags
#+TAGS: relate:helm-package, relate:helm, relate:color-theme, emacs 色設定, emacs theme, emacs color theme, emacs color-theme.el, emacs スキン, emacs テーマ, emacs skin, emacs color setting, emacs カラーテーマ, emacs テーマ 変更, emacs カラーテーマ 設定, emacs 見た目の変更, emacs 好みの色設定, emacs 背景色, , Emacs, theme, , M-x list-packages, M-x occur RET theme, M-x helm-package, M-x helm-list-elisp-packages, color-theme.el, M-x customize-face, custom-file, custom-set-faces
#+end:
