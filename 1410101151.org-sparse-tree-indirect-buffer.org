...
#+MYTAGS: package:org, org-mode, emacs org-mode, org-mode C-c /, make-indirect-buffer, clone-indirect-buffer, emacs 間接バッファ org-mode, org-mode 検索
#+TAGS: package:org, org-mode, emacs org-mode, org-mode C-c /, make-indirect-buffer, clone-indirect-buffer, emacs 間接バッファ org-mode, org-mode 検索, Emacs,, アウトライン, スケジュール管理, 文書作成, C-c /, M-x org-sparse-tree, C-c / /, indirect-buffer
