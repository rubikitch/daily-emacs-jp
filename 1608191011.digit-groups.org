...
#+BLOG: rubikitch
#+CATEGORY: Emacs
#+EL_PKG_NAME: digit-groups大きい数字を読むコツ
...
#+EL_URL: 
#+begin: org2blog
#+DESCRIPTION: Emacs Lispパッケージdigit-groups大きい数字を読むコツの紹介
#+MYTAGS: package:digit-groups大きい数字を読むコツ, emacs 使い方, emacs コマンド, emacs, digit-groups大きい数字を読むコツ, digit-groups大きい数字を読むコツ.el, emacs lisp digit-groups大きい数字を読むコツ, elisp digit-groups大きい数字を読むコツ, emacs  digit-groups大きい数字を読むコツ, emacs digit-groups大きい数字を読むコツ 使い方, emacs digit-groups大きい数字を読むコツ 設定, emacs パッケージ digit-groups大きい数字を読むコツ, emacs digit-groups大きい数字を読むコツ スクリーンショット, 大きい数字を読むコツ, 数字の単位, 命数法, 数字の表記, 桁の大きな数字の読み方, 数字の読み方
#+TAGS: package:digit-groups大きい数字を読むコツ, emacs 使い方, emacs コマンド, emacs, digit-groups大きい数字を読むコツ, digit-groups大きい数字を読むコツ.el, emacs lisp digit-groups大きい数字を読むコツ, elisp digit-groups大きい数字を読むコツ, emacs  digit-groups大きい数字を読むコツ, emacs digit-groups大きい数字を読むコツ 使い方, emacs digit-groups大きい数字を読むコツ 設定, emacs パッケージ digit-groups大きい数字を読むコツ, emacs digit-groups大きい数字を読むコツ スクリーンショット, 大きい数字を読むコツ, 数字の単位, 命数法, 数字の表記, 桁の大きな数字の読み方, 数字の読み方, Emacs, digit-groups.el, digit-groups-mode, font-lock-mode, prog-mode, text-mode, org-mode, digit-groups.el, digit-groups-mode, font-lock-mode, prog-mode, text-mode, org-mode, digit-groups-test
#+TITLE: emacs digit-groups大きい数字を読むコツ.el : 【無量大数以上？】大きい数字を区切って読みやすくする |  Emacs Lisp Elisp パッケージ インストール 設定 使い方 スクリーンショット
#+BEGIN_HTML
<table>
<tr><td>パッケージ名</td><td>digit-groups大きい数字を読むコツ</td></tr>
<tr><td>概要(原文)</td><td>EL_DOCに説明文を入れてください</td></tr>
<tr><td>リポジトリ</td><td>まだパッケージに登録されていない</td></tr>
<tr><td>関連記事</td><td><a href="http://rubikitch.com/tag/package:digit-groups大きい数字を読むコツ/">package:digit-groups大きい数字を読むコツ</a> </td></tr>
</table>
<br />
#+END_HTML
大きい数字を読み上げるのは大変ですよね。
